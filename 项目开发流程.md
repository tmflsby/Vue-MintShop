...
**具体API文档详见[项目API接口文档](https://github.com/tmflsby/Vue-MintShop/blob/master/mintshop-server/API.md)，然后可以使用Postman来进行接口测试**
...
3. 因为修改了项目的config文件，所以需要重启项目`npm run serve`
...
- 完成加减选购食物的组件
  ...
  <div class="cartcontrol">
    ...
    <transition name="move">
      <div class="iconfont icon-removecircleoutline"></div>
    </transition>
